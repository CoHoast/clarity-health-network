          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Present your Clarity Health Network ID card at your appointment to access network rates.",
              },
              {
                step: "03",
                icon: DollarSign,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Use our calculator to estimate your potential savings with Clarity Health Network.
              </p>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-lg">
              ...
              <div className="bg-gradient-to-r from-teal-600 to-emerald-600 rounded-xl p-4 text-white text-center mb-6">
                <p className="text-sm opacity-80">With Clarity Health Network</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote: "Clarity Health Network saved me over $4,000 on my back surgery. The process was seamless.",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              ...
              {
                q: "How much will I save with Clarity Health Network?",
      ...
      <section className="py-20 bg-gradient-to-br from-teal-600 to-emerald-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-teal-100 mb-10">
            Join thousands of members who trust Clarity Health Network for quality, affordable care.
          </p>

                ...
                <div className="bg-white shadow-lg rounded-lg max-w-2xl mx-auto">
                  <div className="p-8 space-y-6">
                    <div className="text-center border-b border-gray-200 pb-6">
                      ...
                      <p className="text-gray-500 mt-2">Clarity Health Network</p>
                    ...
                    <div className="space-y-4">
                      ...
                      <ul className="list-disc list-inside text-gray-600 space-y-2">
                        ...
                        <li>Network: Clarity Health PPO Network</li>
                        <li>Member Services: 1-800-CLARITY</li>
                        <li>Website: members.clarityhealthnetwork.com</li>
                      </ul>

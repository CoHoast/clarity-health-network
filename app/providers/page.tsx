          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-xl text-teal-100 mb-8">
                Becoming a Clarity Health Network provider is simple. Our credentialing process is streamlined and efficient.
              </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { icon: Phone, title: "Provider Hotline", desc: "1-800-CLARITY x2", action: "Call Now" },
              { icon: Mail, title: "Email Support", desc: "providers@clarityhealth.com", action: "Send Email" },

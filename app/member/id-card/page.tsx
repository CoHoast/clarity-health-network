            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div>
                    <h2 className="font-bold text-lg sm:text-xl">TrueCare Health Network</h2>
            ...
            >
              ...
              <div className="flex items-center justify-between mb-3 pb-2 border-b border-gray-200">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-gray-900 text-sm sm:text-base">TrueCare Health Network</span>
                </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-blue-700 mt-1">
            Showing your TrueCare Health Network ID card ensures you receive in-network rates. 
                      ...
                      <div className="bg-gradient-to-br from-teal-500 via-teal-600 to-emerald-600 rounded-2xl p-6 text-white shadow-lg">
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-bold">TrueCare Health Network</span>
                          </div>

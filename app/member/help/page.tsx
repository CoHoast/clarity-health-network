...
const categoryArticles: Record<string, { title: string; summary: string; readTime: string }[]> = {
  ...
  benefits: [
    { title: "Understanding your PPO plan benefits", summary: "Overview of what your TrueCare Health PPO plan covers and how it works.", readTime: "5 min" },
...
const faqs = [
  ...
  },
  {
    ...
    a: "No! With your TrueCare Health PPO plan, you have direct access to any in-network specialist without needing a referral from your primary care physician. This gives you the flexibility to manage your own care."
  },
  {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        ...
        <button 
          onClick={() => window.location.href = 'mailto:support@truecarehealth.com?subject=Support Request'}
          className="flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-xl hover:border-teal-300 hover:shadow-md transition-all"
        >
          ...
          <div className="text-left">
            ...
            <p className="text-gray-500 text-sm">support@truecarehealth.com</p>
          </div>
        </button>
      </div>
              ...
              <div className="overflow-y-auto max-h-[calc(85vh-80px)] p-6">
                ...
                <div className="prose prose-gray max-w-none">
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    As a TrueCare Health member, you have access to comprehensive resources and support.
                  </p>

                  <h2 className="text-lg font-semibold text-gray-900 mt-6 mb-3">Step-by-Step Guide</h2>
                  <ol className="list-decimal list-inside space-y-2 text-gray-600 mb-4">
                    <li>Log in to your member portal at member.truecarehealth.com</li>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                    <p className="text-blue-800 text-sm">
                      💡 <strong>Tip:</strong> You can also complete this action through the TrueCare Health mobile app, 

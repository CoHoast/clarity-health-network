...
const messageThreads: Record<number, Message[]> = {
  ...
  4: [
    ...
    { id: 2, sender: "Credentialing Team", content: "Dr. Garcia's credentialing application has been approved. She is now fully credentialed with Clarity Health Network and can begin seeing our members effective immediately.", time: "Mar 8, 10:01 AM", isMe: false },

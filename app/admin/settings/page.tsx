            ...
            <div className="bg-slate-800/50 rounded-xl border border-slate-700 p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input type="text" defaultValue="Clarity Health Network" className="w-full px-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-1">Legal Entity Name</label>
                  <input type="text" defaultValue="Clarity Health Network, LLC" className="w-full px-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white" />
                </div>
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="email" defaultValue="admin@clarityhealth.com" className="w-full px-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white" />
                  </div>
                </div>
              </div>
            </div>

...
const auditLogs: AuditLog[] = [
  ...
  { id: "LOG-006", timestamp: "2024-03-12 15:25:00", user: "sarah.m@truecare.health", userId: "USR-001", action: "User Created", category: "data_change", resource: "USR-089", resourceType: "User", details: "Created new user: robert.t@truecare.health with role 'Analyst'", ip: "192.168.1.45", userAgent: "Chrome/122.0 Windows", sessionId: "sess_abc123", severity: "warning", phiAccessed: false, success: true },
  ...
  { id: "LOG-017", timestamp: "2024-03-12 14:30:00", user: "james.w@truecare.health", userId: "USR-002", action: "Member Record Accessed", category: "phi_access", resource: "MEM-23456", resourceType: "Member", details: "Accessed full member record including SSN and medical history", ip: "192.168.1.52", userAgent: "Chrome/122.0 Windows", sessionId: "sess_pqr678", severity: "info", phiAccessed: true, success: true },
  { id: "LOG-018", timestamp: "2024-03-12 14:25:45", user: "sarah.m@truecare.health", userId: "USR-001", action: "Logout", category: "auth", resource: "AUTH", resourceType: "Authentication", details: "User logged out", ip: "192.168.1.45", userAgent: "Chrome/122.0 Windows", sessionId: "sess_abc123", severity: "info", phiAccessed: false, success: true },
  ...
  { id: "LOG-020", timestamp: "2024-03-12 14:15:00", user: "lisa.r@truecare.health", userId: "USR-005", action: "Claim Denied", category: "data_change", resource: "CLM-2024-148", resourceType: "Claim", details: "Denied claim for $95.00 - Reason: Out of network provider", ip: "192.168.1.88", userAgent: "Chrome/122.0 Windows", sessionId: "sess_abc890", severity: "info", phiAccessed: true, success: true },
];

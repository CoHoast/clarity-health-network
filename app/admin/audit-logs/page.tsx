...
const auditLogs: AuditLog[] = [
  { id: "LOG-001", timestamp: "2024-03-12 15:42:33", user: "sarah.m@clarity.health", userId: "USR-001", action: "Claim Approved", category: "data_change", resource: "CLM-2024-156", resourceType: "Claim", details: "Approved claim for $450.00, changed status from 'pending' to 'approved'", ip: "192.168.1.45", userAgent: "Chrome/122.0 Windows", sessionId: "sess_abc123", severity: "info", phiAccessed: true, success: true },
  ...
  { id: "LOG-003", timestamp: "2024-03-12 15:35:45", user: "sarah.m@clarity.health", userId: "USR-001", action: "Fee Schedule Updated", category: "data_change", resource: "FS-001", resourceType: "Fee Schedule", details: "Updated 23 CPT codes in Primary Care fee schedule", ip: "192.168.1.45", userAgent: "Chrome/122.0 Windows", sessionId: "sess_abc123", severity: "warning", phiAccessed: false, success: true },
  ...
  { id: "LOG-006", timestamp: "2024-03-12 15:25:00", user: "sarah.m@clarity.health", userId: "USR-001", action: "User Created", category: "data_change", resource: "USR-089", resourceType: "User", details: "Created new user: robert.t@clarity.health with role 'Analyst'", ip: "192.168.1.45", userAgent: "Chrome/122.0 Windows", sessionId: "sess_abc123", severity: "warning", phiAccessed: false, success: true },
  ...
  { id: "LOG-008", timestamp: "2024-03-12 15:15:12", user: "sarah.m@clarity.health", userId: "USR-001", action: "System Config Changed", category: "system", resource: "SYS-CONFIG", resourceType: "System", details: "Modified password policy: min length 8→12 characters", ip: "192.168.1.45", userAgent: "Chrome/122.0 Windows", sessionId: "sess_abc123", severity: "warning", phiAccessed: false, success: true },
  ...
  { id: "LOG-014", timestamp: "2024-03-12 14:45:00", user: "david.k@clarity.health", userId: "USR-006", action: "Fraud Alert Cleared", category: "data_change", resource: "FRD-2024-034", resourceType: "Fraud Alert", details: "Cleared fraud alert as false positive after investigation", ip: "192.168.1.75", userAgent: "Chrome/122.0 MacOS", sessionId: "sess_vwx234", severity: "warning", phiAccessed: true, success: true },
  { id: "LOG-015", timestamp: "2024-03-12 14:40:22", user: "sarah.m@clarity.health", userId: "USR-001", action: "User Role Modified", category: "data_change", resource: "USR-007", resourceType: "User", details: "Changed role from 'Member Services' to 'Claims Processor' for jennifer.l@clarity.health", ip: "192.168.1.45", userAgent: "Chrome/122.0 Windows", sessionId: "sess_abc123", severity: "warning", phiAccessed: false, success: true },
  ...
  { id: "LOG-017", timestamp: "2024-03-12 14:30:00", user: "james.w@clarity.health", userId: "USR-002", action: "Member Record Accessed", category: "phi_access", resource: "MEM-23456", resourceType: "Member", details: "Accessed full member record including SSN and medical history", ip: "192.168.1.52", userAgent: "Chrome/122.0 Windows", sessionId: "sess_pqr678", severity: "info", phiAccessed: true, success: true },
  { id: "LOG-018", timestamp: "2024-03-12 14:25:45", user: "sarah.m@clarity.health", userId: "USR-001", action: "Logout", category: "auth", resource: "AUTH", resourceType: "Authentication", details: "User logged out", ip: "192.168.1.45", userAgent: "Chrome/122.0 Windows", sessionId: "sess_abc123", severity: "info", phiAccessed: false, success: true },
  ...
  { id: "LOG-020", timestamp: "2024-03-12 14:15:00", user: "lisa.r@clarity.health", userId: "USR-005", action: "Claim Denied", category: "data_change", resource: "CLM-2024-148", resourceType: "Claim", details: "Denied claim for $95.00 - Reason: Out of network provider", ip: "192.168.1.88", userAgent: "Chrome/122.0 Windows", sessionId: "sess_abc890", severity: "info", phiAccessed: true, success: true },
];

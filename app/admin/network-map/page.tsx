    ...
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-800/50 rounded-xl border border-slate-700 p-6">
          ...
          <div className="space-y-3">
            {[
              { spec: "Multi-Specialty", count: providers.filter(p => p.specialty === "Multi-Specialty").reduce((s, p) => s + p.providers, 0), color: "bg-purple-500" },
          ...
          <>
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <div className="bg-gradient-to-r from-purple-500/10 to-teal-500/10 border border-purple-500/30 rounded-lg p-4">

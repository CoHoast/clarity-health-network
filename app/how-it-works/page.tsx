        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Getting started with Clarity Health Network is easy. 
          ...
          <div className="space-y-20">
            {[
              ...
              },
              {
                ...
                description: "At your appointment, present your Clarity Health Network member ID card. Your provider will verify your network status and apply our negotiated rates.",
